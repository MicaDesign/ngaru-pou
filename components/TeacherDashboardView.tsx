  ...
  return (
    <div className="rounded-2xl border border-midnight-tidal/25 bg-salt-mist p-7 md:p-8">
      ...
      {loading ? (
        ...
        <ul className="divide-y divide-midnight-tidal/10">
          {students.map((s) => (
    ...
    <li className="py-5">
      <div className="flex items-start gap-4 flex-wrap">
        ...
        <div className="flex-1">
          <p className="font-sans text-lg font-medium text-midnight-tidal">
...
function PendingKaiakoSection({
  ...
  return (
    <div className="rounded-2xl border border-semantic-yellow/25 bg-salt-mist p-7 md:p-8">
      <div className="flex items-center gap-3 mb-6">
        <UserCheck size={20} className="text-semantic-yellow" />
        <h2 className="font-display text-2xl text-midnight-tidal">kaiako requests</h2>
      </div>
...
function KaiakoRequestCard({
  ...
  return (
    <li className="rounded-xl border border-midnight-tidal/25 bg-white p-5">
      ...
      {profile.experience && (
        <p className="font-sans text-sm text-midnight-tidal/70 leading-relaxed mb-4 whitespace-pre-line">
          {profile.experience}
        </p>
      )}
    ...
    <div className="rounded-2xl border border-midnight-tidal/25 bg-salt-mist p-7 md:p-8">
      ...
      {loading ? (
        <div className="flex justify-center py-8">
          <Loader2 size={24} className="text-midnight-tidal/30 animate-spin" />
        </div>
      ) : questions.length === 0 ? (
        <div className="py-6">
...
function QuestionCard({
  ...
  return (
    <li className="rounded-xl border border-midnight-tidal/25 bg-white p-5">
      ...
      <p className="font-sans text-midnight-tidal/80 leading-relaxed mb-4 whitespace-pre-line">
        {question.question}
      </p>
  ...
  return (
    <div className="rounded-2xl border border-midnight-tidal/25 bg-salt-mist p-7 md:p-8">
      ...
      {loading ? (
        ...
        <ul className="divide-y divide-midnight-tidal/10 max-h-96 overflow-y-auto">
          {eois.map((e) => (
