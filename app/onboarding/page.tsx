  ...
  return (
    <AuthGuard>
      <div className="min-h-screen bg-midnight-tidal px-6 py-12 md:py-16 flex flex-col items-center">
        <Link href="/" className="mb-12 md:mb-16 transition-transform duration-300 ease-[cubic-bezier(.165,.84,.44,1)] hover:scale-[1.03]">
          <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          <Link
            ...
            className="group relative bg-iron-depth border border-white/[0.11] rounded-2xl p-8 md:p-10 transition-all duration-300 ease-[cubic-bezier(.165,.84,.44,1)] hover:-translate-y-1 hover:border-primary/50 hover:shadow-[0_18px_40px_rgba(5,10,28,0.4)]"
          >
