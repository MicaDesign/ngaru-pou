          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <FadeUp key={step.number} delay={i * 0.07}>
                <div className="relative flex flex-col gap-5 rounded-2xl border border-white/[0.11] bg-iron-depth/50 p-8 h-full hover:bg-iron-depth transition-colors duration-300">
                  ...
                  <h3 className="font-sans text-[1.2rem] font-semibold text-white leading-snug">
                    {step.title}
                  </h3>
                  <p className="font-sans text-white/55 text-[1.05rem] leading-relaxed">
                    {step.body}
                  </p>
                </div>
              </FadeUp>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeUp delay={0.1} direction="right">
              ...
              <ul className="space-y-3 mb-10">
                {whyPoints.map((point) => (
                  <li key={point} className="flex items-start gap-3 font-sans text-white/70 text-[1.05rem]">
